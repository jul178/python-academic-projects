''' This module contains functions to trace a path on a treasure map,
determine its shape (vertices), calculate area, and count the number
of treasures (interior points)
'''
